import { Avatar, Image, Box, Button, Container, Hide, IconButton, Input, InputGroup, InputRightElement, Text, useColorMode } from '@chakra-ui/react'
      ...
      <Container>
       <InputGroup>
        ...
        <Container display='flex' gap={7}>
            <Button leftIcon={<AiOutlineUpload  size={22}  />} colorScheme="messenger"> <Link to="/upload">Upload</Link> </Button>
            {getAuthState() }
